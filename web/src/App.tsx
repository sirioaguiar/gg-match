            ...
            <form className='mt-8 flex flex-col gap-4'>
              <div className='flex flex-col gap-2'>
                <label htmlFor='game' className='font-semibold'>Qual o jogo?</label>
                  <Input
                    id='game' placeholder='Selecione o jogo que deseja jogar' 
                  />
              </div>  
              <div className='flex flex-col gap-2'>
              ...
              <div className='flex flex-col gap-2'>
                  ...
                  <Input id='yearsPlaying' type='number' placeholder='' 
                  />
                </div>
                <div className='flex flex-col gap-2'>
                  <label htmlFor='discord'>Qual seu Discord?</label>
                  <Input id='discord' type='text' placeholder='Usuario#XXXXXX' 
                  />
                </div>
              </div>
